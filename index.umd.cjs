...
$root.pb = (function() {
    ...
    pb.Vec3 = (function() {
        ...
        Vec3.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.pb.Vec3();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                case 1: {
    ...
    pb.Quat = (function() {
        ...
        Quat.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.pb.Quat();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                case 1: {
    ...
    pb.Color = (function() {
        ...
        Color.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.pb.Color();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                case 1: {
    ...
    pb.Element = (function() {
        ...
        Element.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.pb.Element();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                case 1: {
        ...
        Element.fromObject = function fromObject(object) {
            if (object instanceof $root.pb.Element)
                return object;
            var message = new $root.pb.Element();
            if (object.name != null)
    ...
    pb.Asset = (function() {
        ...
        Asset.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.pb.Asset();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                case 1: {
    ...
    pb.Material = (function() {
        ...
        Material.encode = function encode(message, writer) {
            ...
            if (message.assets != null && Object.hasOwnProperty.call(message, "assets"))
                for (var keys = Object.keys(message.assets), i = 0; i < keys.length; ++i) {
        ...
        Material.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.pb.Material(), key, value;
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                case 1: {
        ...
        Material.verify = function verify(message) {
            ...
            if (message.assets != null && message.hasOwnProperty("assets")) {
                ...
                var key = Object.keys(message.assets);
                for (var i = 0; i < key.length; ++i) {
                    var error = $root.pb.Asset.verify(message.assets[key[i]]);
                    if (error)
                        return "assets." + error;
                }
            }
            if (message.emissive != null && message.hasOwnProperty("emissive")) {
                var error = $root.pb.Color.verify(message.emissive);
                if (error)
            ...
            if (message.specular != null && message.hasOwnProperty("specular")) {
                var error = $root.pb.Color.verify(message.specular);
                if (error)
        ...
        Material.fromObject = function fromObject(object) {
            ...
            if (object.assets) {
                ...
                message.assets = {};
                for (var keys = Object.keys(object.assets), i = 0; i < keys.length; ++i) {
    ...
    pb.Mesh = (function() {
        ...
        Mesh.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.pb.Mesh();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                case 1: {
        ...
        Mesh.verify = function verify(message) {
            ...
            if (message.elements != null && message.hasOwnProperty("elements")) {
                ...
                for (var i = 0; i < message.elements.length; ++i) {
                    var error = $root.pb.Element.verify(message.elements[i]);
                    if (error)
    ...
    pb.MeshInstance = (function() {
         ...
         * @property {string|null} [nodeName] MeshInstance nodeName
         ...
         * @instance
         */
        MeshInstance.prototype.nodeName = "";
        ...
        MeshInstance.encode = function encode(message, writer) {
            ...
            if (message.mesh != null && Object.hasOwnProperty.call(message, "mesh"))
                $root.pb.Mesh.encode(message.mesh, writer.uint32(/* id 3, wireType 2 =*/26).fork()).ldelim();
            if (message.material != null && Object.hasOwnProperty.call(message, "material"))
                $root.pb.Material.encode(message.material, writer.uint32(/* id 4, wireType 2 =*/34).fork()).ldelim();
        ...
        MeshInstance.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.pb.MeshInstance(), key, value;
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                case 1: {
    ...
    pb.Node = (function() {
        ...
        Node.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.pb.Node();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                case 1: {
        ...
        Node.verify = function verify(message) {
            ...
            if (message.children != null && message.hasOwnProperty("children")) {
                ...
                for (var i = 0; i < message.children.length; ++i) {
                    var error = $root.pb.Node.verify(message.children[i]);
                    if (error)
            ...
            if (message.position != null && message.hasOwnProperty("position")) {
                var error = $root.pb.Vec3.verify(message.position);
                if (error)
                    return "position." + error;
            }
            if (message.rotation != null && message.hasOwnProperty("rotation")) {
                var error = $root.pb.Quat.verify(message.rotation);
                if (error)
                    return "rotation." + error;
            }
            if (message.scale != null && message.hasOwnProperty("scale")) {
                var error = $root.pb.Vec3.verify(message.scale);
                if (error)
                    return "scale." + error;
            }
            if (message.meshInstances != null && message.hasOwnProperty("meshInstances")) {
                ...
                for (var i = 0; i < message.meshInstances.length; ++i) {
                    var error = $root.pb.MeshInstance.verify(message.meshInstances[i]);
                    if (error)
        ...
        Node.fromObject = function fromObject(object) {
            ...
            if (object.meshInstances) {
                ...
                message.meshInstances = [];
                for (var i = 0; i < object.meshInstances.length; ++i) {
