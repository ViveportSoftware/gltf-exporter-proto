...
$root.pb = (function() {
    ...
    pb.Material = (function() {
        ...
        Material.fromObject = function fromObject(object) {
            ...
            if (object.diffuseFactor) {
                ...
                message.diffuseFactor = [];
                for (var i = 0; i < object.diffuseFactor.length; ++i)
            ...
            if (object.specularFactor) {
                ...
                message.specularFactor = [];
                for (var i = 0; i < object.specularFactor.length; ++i)
        ...
        Material.toObject = function toObject(message, options) {
            ...
            if (message.diffuseFactor && message.diffuseFactor.length) {
                object.diffuseFactor = [];
                for (var j = 0; j < message.diffuseFactor.length; ++j)
            ...
            if (message.specularFactor && message.specularFactor.length) {
                object.specularFactor = [];
                for (var j = 0; j < message.specularFactor.length; ++j)
    ...
    pb.MeshInstance = (function() {
        ...
        MeshInstance.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.pb.MeshInstance();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                case 1: {
